 ...
 */
var exportSchema = function (filepath, filename, schema) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _b, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                _b = (_a = fs_1.default).writeFileSync;
                _c = [path_1.default.join(filepath, "".concat(filename, ".prisma"))];
                return [4 /*yield*/, schema.toString()];
            case 1:
                _b.apply(_a, _c.concat([_d.sent(), "utf-8"]));
                return [2 /*return*/];
        }
    });
}); };
